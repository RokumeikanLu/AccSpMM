...
- This repository fixes the typos/issues in the [official code](https://github.com/AI4SClab/AccSpMM) of [Acc-SpMM](https://arxiv.org/pdf/2501.09251) (PPoPP25).
    ...
    - Reset output for the last kernel launch in `include/tf32_comp.hpp` to obtain a single round output, since the adap kernel uses atomic add and thus it cannot overwrite the output matrix C, which has been written for many times in previous rounds.
